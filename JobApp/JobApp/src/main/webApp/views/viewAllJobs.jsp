...
<%@ page import="com.SpringBoot_Project_2.JobApp.Model.JobPost" %>
<%@ page import="com.SpringBoot_Project_2.JobApp.Repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://yourcontactlink.com/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>

<!-- Ensure that the jobPosts attribute is passed correctly -->
